...
def test_typed_output_flows_to_downstream_kwarg():
    ...
    reg.register(ToolEntry(
        name="focus", phrases=(), func=_focus, module="x", docstring=None,
        internal=True, returns_meta={"hwnd": {"type": "integer", "description": "x"}},
    ))
    reg.register(ToolEntry(
        name="consume_hwnd", phrases=(), func=_consume, module="x", docstring=None,
        internal=True,
    ))
